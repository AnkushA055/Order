...
export class GreatOutdoorsDataService implements InMemoryDbService {
  ...
  createDb() {
    ...
    let orderDetails = [
      new OrderDetail(1, "101010", "1010", "2010", 5,1200  , 6000, "InCart", "10", "01/01/2018", "02/01/2018" ),
      new OrderDetail(2, "101011", "1010", "2011", 5, 700  , 3500, "InCart", "10", "01/01/2018", "02/01/2018" ),
      new OrderDetail(3, "101012", "1010", "2010", 5, 1200  , 6000, "InCart", "10", "01/01/2018", "02/01/2018" ),
    ];

    let products = [
      new Product(1, "2010", "BCKPCK", "Back Pack", "Camping Equipment", "assets/images/1.jpg", 10, "Small", "Black", "Material - Polyester, Strap - Adjustable",
        1000, 1200, 0),
